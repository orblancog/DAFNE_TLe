...
AI_TTLINE: line=(-TT2,1*(DHPTT001,DHPTT001yr),-TT1);
...
! right tranfer line ; 
! orblancog 2016.10 Changing magnet order SPTA2001 first ???
ASPTeout: LINE= (1*(SPTA2001,SPTA2001YR),D1,1*(SPTA2002,SPTA2002YR));
...
TRLINE: line=(ASPTeout,TR1,1*(DVRTR001,(roll1,DVRTR001yr,ROLL2)),TR2,1*(DVRTR002,(ROLL1,DVRTR002YR,ROLL2)),TR3);
...
TTLINE: line=(TT1,1*(DHPTT001,DHPTT001yr),TT2,1*(DHPTT002,DHPTT002yr),TT3,DHRTT001,DHRTT001yr,TT4,1*(DHSTT001,DHSTT001yr),
              TT5,1*(DVRTT001,(roll1,DVRTT001yr,roll2)),TT6,1*(DVRTT002,(roll1,DVRTT002yr,roll2)),TT7);
...
TELINE: line=(TE1,1*(DVRTE001,(roll1,DVRTE001yr,roll2)),TE2,
1*(DVRTE002,(roll1,DVRTE002yr,roll2)),TE3,1*(DHRTE001,DHRTE001YR),TE4,
1*(DHRTE002,DHRTE002yr),TE5,1*(DHRTE003,DHRTE003yr),TE6,
1*(DVRTE003,(roll1,DVRTE003yr,roll2)),TE7,1*(DVRTE004,1*(roll1,DVRTE004yr,roll2)));

e_SPT : line=(D68,1*(SPTEL101,SPTEL101yr),D69,1*(SPTEL102,SPTEL102yr),D70);

! accum -> dafne;

e_AE: line=(TRLINE,1*(DHYTT001,DHYTT001YR),TTLINE,TELINE,e_SPT,FL1EL101);
...
! linac -> accum
 p_Ai: line = (TMLINE,AI_TTLINE,(DHYTT001,DHYTT001YR),-TRLINE);
