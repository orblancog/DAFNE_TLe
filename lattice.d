...
ASPTeout: LINE= (4*(SPTA2001,SPTA2001K),D1,60*(SPTA2002,SPTA2002K));
...
TRLINE: line=(ASPTeout,TR1,20*(DVRTR001,DVRTR001K),TR2,20*(DVRTR002,DVRTR002K),TR3);
...
TTLINE: line=(TT1,80*(DHPTT001,DHPTT001k),TT2,80*(DHPTT002,DHPTT002K),TT3,DHRTT001,TT4,80*(DHSTT001,DHSTT001k),
              TT5,20*(DVRTT001,DVRTT001k),TT6,20*(DVRTT002,DVRTT002k),TT7);
...
TELINE: line=(TE1,20*(DVRTE001,DVRTE001k),TE2,20*(DVRTE002,DVRTE002k),TE3,DHRTE001,TE4,DHRTE002,
...
e_AE: line=(TRLINE,80*(DHYTT001,DHYTT001K),TTLINE,TELINE,e_SPT,FL1EL101);
