...
AI_TTLINE: line=(-TT2,80*(DHPTT001,DHPTT001k),-TT1);
...
ASPTeout: LINE= (1*(SPTA2001,SPTA2001K),D1,1*(SPTA2002,SPTA2002K));
...
TRLINE: line=(ASPTeout,TR1,1*(DVRTR001,DVRTR001K),TR2,1*(DVRTR002,DVRTR002K),TR3);
...
TTLINE: line=(TT1,1*(DHPTT001,DHPTT001k),TT2,1*(DHPTT002,DHPTT002K),TT3,DHRTT001,DHRTT001k,TT4,1*(DHSTT001,DHSTT001k),
              TT5,1*(DVRTT001,DVRTT001k),TT6,1*(DVRTT002,DVRTT002k),TT7);
...
TELINE: line=(TE1,1*(DVRTE001,DVRTE001k),TE2,1*(DVRTE002,DVRTE002k),TE3,DHRTE001,dhrte001k,TE4,DHRTE002,DHRTE002k,
              TE5,DHRTE003,DHRTE003k,,TE6,1*(DVRTE003,DVRTE003k),TE7,1*(DVRTE004,DVRTE004k));

e_SPT : line=(D68,1*(SPTEL101,SPTEL101k),D69,1*(SPTEL102,SPTEL102k),D70);

! accum -> dafne;

e_AE: line=(TRLINE,1*(DHYTT001,DHYTT001K),TTLINE,TELINE,e_SPT,FL1EL101);
