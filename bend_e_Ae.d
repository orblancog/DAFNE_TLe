...
value, spta2001k->hkick/spta2001->angle;
!stop;
...
value, spta2002k->hkick/spta2002->angle;
!stop;
...
value, dvrtr001k->vkick/dvrtr001->angle;
!stop;
...
value, dvrtr002k->vkick/dvrtr002->angle;
!stop;
...
value, DHYTT001k->hkick/DHYTT001->angle;
!stop;
...
value, DHPTT001k->hkick/DHPTT001->angle;
!stop;!
...
value, DHPTT002k->hkick/DHPTT002->angle;
!stop;!
...
value, DHRTT001k->hkick/DHRTT001->angle;
!stop;!
...
value, DHSTT001k->hkick/DHSTT001->angle;
!stop;
...
DVRTT001 : SBEND,L:=LDVRTT001,TILT:=TWOPI/4,ANGLE:=0*vdon*MANGDVRTT001,E1=0.095993,E2=0.095993;!magnetic angle
! fake kicker to match the physical angle in the TL
DVRTT001K: KICKER,L=0,VKICK:=tkon*(PANGDVRTT001 - MANGDVRTT001);
!value, dvrtt001k->vkick;
value, dvrtt001->angle;
value, dvrtt001k->vkick/dvrtt001->angle;
!stop;
...
DVRTT002 : SBEND,L:=LDVRTT002,TILT:=TWOPI/4,ANGLE:=0*vdon*MANGDVRTT002,E1=0.095993,E2=0.095993;!magnetic angle
! fake kicker to match the physical angle in the TL
DVRTT002K: KICKER,L=0,VKICK:=tkon*(PANGDVRTT002 - MANGDVRTT002);
!value, dvrtt002k->vkick;
value, dvrtt002->angle;
value, dvrtt002k->vkick/dvrtt002->angle;
!stop;
...
value, dvrte001k->vkick/dvrte001->angle;
!stop;
...
value, dvrte002k->vkick/dvrte002->angle;
!stop;
...
value, DHRTE001k->hkick/DHRTE001->angle;
!stop;!
...
value, DHRTE002k->hkick/DHRTE002->angle;
!stop;!
...
value, DHRTE003k->hkick/DHRTE003->angle;
!stop;!
...
value, dvrte003k->vkick/dvrte003->angle;
!stop;
...
value, dvrte004k->vkick/dvrte004->angle;
!stop;
...
value, sptel101k->hkick/sptel101->angle;
!stop;
...
value, sptel102k->hkick/sptel102->angle;
!stop;
